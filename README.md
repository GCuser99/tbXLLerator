...
- **UDF registration class** — High-level registration mechanism including `ThreadSafe`, `Volatile`, `MacroType` properties and automatic type-text string construction
